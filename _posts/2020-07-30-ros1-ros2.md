...
### 아키텍쳐 비교
![Relation](//gwkim9444.github.io/_posts/picture/ros_diffrence.png)
...
![Relation](../_posts/picture/1.png)

    두대의 6축 로봇을 `Gazebo` 안에서 두개의 Rviz로 제어하는 모습

![Relation](../_posts/picture/2.png)
   
    두대 이상의 로봇은 보다 복잡한 tf map을 그린다.
![Relation](../_posts/picture/3.png)
...
![Relation](../_posts/picture/4.png)

ROS에서 패키지를 생성한 경우 다음과 같은 디렉터리 구조를 만들 수 있다.

![Relation](../_posts/picture/5.png)  
